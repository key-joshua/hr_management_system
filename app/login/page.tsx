...
import { decrypt, generateDeviceId, signinValidation } from "@/libs/utils/utils"
              ...
              <div className="absolute top-10 left-1/2 transform -translate-x-1/2 z-20">
                <div className="flex flex-col items-center text-center">
                  <div className="flex items-center justify-center gap-3 mb-2">
                    ...
                    <Link href="/">  <h1 className="text-2xl font-bold text-primary-active [@media(max-width:550px)]:text-sm"> HR Management </h1> </Link>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center justify-center">
                  <div className="relative w-full max-w-[260px]">
                    <div className="relative aspect-square">
                      <Image src="/login-form-background.svg" alt="HR Management Illustration" fill className="object-contain" priority />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="w-full max-w-xs mx-auto">
                    ...
                    <form className="space-y-5">
                      ...
                      <div className="space-y-4 pt-2">
                        ...
                        <Button disabled={googleButtonIsLoading} onClick={() => googleSignin()} type="button" variant="outline" className="w-full h-12 border-primaryBlue font-semibold rounded-lg text-white-active bg-primary-semi-active hover:text-white-active hover:bg-primary-mini-active transition-colors" >
                          ...
                          { googleButtonIsLoading ? <ButtonLoader /> : "Login with Google" }
                        </Button>
                      </div>
                    </form>
                  </div>
